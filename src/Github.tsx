  ...
  public group(style: any): JSX.Element {
    return (
      <g>
        ...
        <path d="M 1 12, A 1 1, 0, 0, 0, 23 12, A 1 1, 0, 0, 0, 1 12" stroke={style.fill} fill="transparent" strokeWidth="1.5" />
        <path d="M 9 19, A 3 3, 0, 0, 1, 6.5, 18, A 3 3, 0, 0, 0, 4, 16, A 1 1, 0, 0, 1, 4, 15.5, A 3 3, 0, 0, 1, 6.5, 16, A 2 2, 0, 0, 0, 10, 16.5, L 9 19" stroke={style.color} fill={style.fill} strokeWidth="0" />
      </g>
    );
  }
  public render() {

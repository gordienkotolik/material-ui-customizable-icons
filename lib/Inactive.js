...
var Inactive = function (_SvgIcon_1$default) {
    (0, _inherits3.default)(Inactive, _SvgIcon_1$default);

    function Inactive() {
        (0, _classCallCheck3.default)(this, Inactive);

        var _this = (0, _possibleConstructorReturn3.default)(this, (Inactive.__proto__ || (0, _getPrototypeOf2.default)(Inactive)).apply(this, arguments));

        _this.displayName = 'Inactive';
        return _this;
    }
    ...
    (0, _createClass3.default)(Inactive, [{
        ...
        value: function group(style, pallet) {
            return React.createElement("g", null, React.createElement("circle", { cx: "12", cy: "12", r: "12", fill: pallet.circle }), React.createElement("path", { d: "M 4 12 L 11 18", stroke: pallet.tick, fill: "transparent", strokeWidth: "3" }), React.createElement("path", { d: "M 9 18 L 20 7", stroke: pallet.tick, fill: "transparent", strokeWidth: "3" }), React.createElement("path", { d: "M 2 2 L 22 22", stroke: pallet.crossing, fill: "transparent", strokeWidth: "3" }));
        }
    }, {
        key: "render",
